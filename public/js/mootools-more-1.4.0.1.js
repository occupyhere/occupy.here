...
// Load this file's selection again by visiting: http://mootools.net/more/08758453e2505754e55fe0cda6b38df0 
// Or build this file again with packager using: packager build More/Date More/Fx.Scroll More/Fx.Slide More/Color
/*
---
copyrights:
...
Locale.addEvent("change",function(s){if(Locale.get("Date")){b(s);}}).fireEvent("change",Locale.getCurrent());})();(function(){Fx.Scroll=new Class({Extends:Fx,options:{offset:{x:0,y:0},wheelStops:true},initialize:function(c,b){this.element=this.subject=document.id(c);
